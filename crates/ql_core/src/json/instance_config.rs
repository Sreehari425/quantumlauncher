...
pub struct InstanceConfigJson {
    ...
    /// 
    /// This allows you to:
    /// - Fix platform compatibility issues (e.g., macOS ARM64, Linux ARM64)
    /// - Test different LWJGL versions for performance
    /// - Use newer LWJGL with older Minecraft versions
    /// 
    /// **⚠️ Warning:** LWJGL 2.x and 3.x are NOT compatible!
