...
icon_define!(file, '\u{e912}');
icon_define!(file_download, '\u{e90d}');
icon_define!(file_gear, '\u{e90e}');
icon_define!(file_info, '\u{e90f}');
icon_define!(file_jar, '\u{e910}');
icon_define!(file_zip, '\u{e911}');
