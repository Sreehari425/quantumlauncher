            ...
            MenuEditLwjgl::Loaded {
                ...
                widget::column![
                        ...
                        widget::column![
                            ...
                            widget::container(
                                widget::column![
                                    ...
                                    widget::text("• Minecraft 1.12.2 and below use LWJGL 2.x")
                                        .size(12),
                                    widget::text("• Minecraft 1.13+ use LWJGL 3.x").size(12),
                                    widget::text("• Using the wrong version will crash the game")
                                        .size(12),
                                ]
                                .spacing(2)
                            )
                            .padding(10)
                            .style(|_theme: &LauncherTheme| {
                                widget::container::Style {
                                    background: Some(
                                        iced::Color::from_rgb(0.2, 0.15, 0.1).into()
                                    ),
                                    border: iced::Border {
                    ...
                    widget::row![
                        ...
                        .on_press_maybe(if has_changed && !is_applying {
