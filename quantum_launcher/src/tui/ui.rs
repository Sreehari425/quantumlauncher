            ...
            if app.settings_focus == SettingsFocus::Left {
                ...
                if app.license_selected == 0 {
                    ...
                    let about_lines: Vec<Line> = vec![
                        ...
                        Line::from("TUI subsystem: contributed and maintained by Sreehari425 (PR pending)."),
                        Line::from("This TUI provides a terminal interface for low-resource or server environments."),
                        Line::from("") ,
                        Line::from("Project licensed under the GNU GPL v3. See the bundled LICENSE file for the full text."),
